...
class _VolunteerDashboardState extends State<VolunteerDashboard> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      // Get total points for the volunteer
      final totalPoints = await pointService.getTotalPointsForVolunteer(user.id);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                // Points Card (Replacing Events Registered)
                _buildStatCard(
                  context,
                  icon: Icons.stars,
...
//       double attendancePercentage = 0; // Default to 100%
//       if (attendanceRecords.isNotEmpty) {
//         attendancePercentage = (eventsAttended / attendanceRecords.length) * 100;
//       }
