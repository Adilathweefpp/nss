...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void _populateFields(EventModel event) {
    ...
    _startTime = TimeOfDay(hour: event.startDate.hour, minute: event.startDate.minute);
    _endDate = event.endDate;
    _endTime = TimeOfDay(hour: event.endDate.hour, minute: event.endDate.minute);
  }
  ...
  Future<void> _selectStartDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      firstDate: DateTime.now().subtract(const Duration(days: 365)), // Allow past dates for fixing errors
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Display event ID as text in the app bar
          Center(
            child: Padding(
